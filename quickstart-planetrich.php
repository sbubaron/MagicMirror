...
define('CREDENTIALS_PATH', __DIR__ . '/.credentials/gcal-planetrich-access-token.json');
define('CLIENT_SECRET_PATH', __DIR__ . '/.credentials/client_secret.json');
define('REFRESH_PATH', __DIR__ . '/.credentials/gcal-planetrich-refresh-token.json');
...
function getClient() {
  ...
  $refreshPath = expandHomeDirectory(REFRESH_PATH);
  ...
  if (file_exists($credentialsPath)) {
    $accessToken = file_get_contents($credentialsPath);
          ...
          file_put_contents($refreshPath, $refreshToken);
          printf("Credentials saved to %s\n", $refreshPath);
  }
