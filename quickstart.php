...
define('CREDENTIALS_PATH', '~/.credentials/gcal-planetrich-access-token.json');
define('CLIENT_SECRET_PATH', __DIR__ . '/.credentials/client_secret.json');
define('REFRESH_PATH', '~/.credentials/gcal-planetrich-refresh-token.json');
...
function getClient() {
  ...
  if (file_exists($credentialsPath)) {
    ...
    if(isset($authObj->refresh_token)) {
        ...
        file_put_contents($refreshPath, $authObj->refresh_token);
        printf("Credentials saved to %s\n", $refreshPath);
    }
  }
